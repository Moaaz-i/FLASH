    ...
    nav: [
      ...
      },
      {
        ...
        items: [
          ...
          { text: '⚡ Vector Quantization (32x RAM)', link: '/guide/vector-quantization' },
          { text: '🌐 Polyglot Query Engine (Any Language)', link: '/guide/polyglot-query-engine' },
          { text: '🤖 Autonomous AI Agent Tools', link: '/guide/ai-agent-tools' },
          { text: '🎯 RAG Context Optimizer (RRF)', link: '/guide/rag-context-optimizer' },
          { text: 'AI Semantic LLM Cache', link: '/guide/ai-semantic-cache' },
          { text: 'AI Vector Search (RAG)', link: '/guide/vector-search' },
          { text: 'HNSW Graph Vector Engine', link: '/guide/hnsw-vector-search' },
...

      {
        ...
        items: [
          ...
          { text: 'Distributed Sharding Ring', link: '/guide/distributed-sharding' },
          { text: 'Distributed Locks & CDC', link: '/guide/scaling-distributed' },
          { text: 'Spatial, Blob & Browser', link: '/guide/storage-spatial-blob' },
          { text: 'LSM-Tree Compactor', link: '/guide/compactor' },
          { text: 'Real-Time Change Streams', link: '/guide/change-streams' },
          { text: 'ACID Transactions & MVCC', link: '/guide/mvcc-transactions' }
        ]
      },
      {
        text: '🛡️ Security',
        items: [
          { text: 'Zero-Knowledge Security', link: '/guide/zero-knowledge-security' },
          { text: 'Security, RBAC & Audit', link: '/guide/security-compliance' },
      ...
      '/guide/': [
...

        {
          ...
          items: [
            ...
            { text: 'Distributed Sharding Ring', link: '/guide/distributed-sharding' },
            { text: 'Distributed Locks & CDC', link: '/guide/scaling-distributed' },
            { text: 'Spatial, Blob & Browser Storage', link: '/guide/storage-spatial-blob' },
            { text: 'LSM-Tree Compactor', link: '/guide/compactor' },
            { text: 'Real-Time Change Streams', link: '/guide/change-streams' },
            { text: 'ACID Transactions & MVCC', link: '/guide/mvcc-transactions' }
          ]
      ...
      '/api/': [
        {
          ...
          items: [
            ...
            { text: 'FlashBinary Zero-Copy Engine', link: '/api/binary-engine' },
            { text: 'Enterprise & Scale APIs', link: '/api/enterprise-api' },
            { text: 'Performance Benchmarks', link: '/api/benchmarks' }
          ]
        }
